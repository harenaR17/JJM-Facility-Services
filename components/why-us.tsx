...
const arguments_ = [
  ...
  'Trained professionals for offices, medical, education & industrial spaces',
  'Quality service guaranteed at the lowest price',
  'Local company proudly serving the Cleveland / Middleburg Heights area',
]
...
function CheckIcon() {
  return (
    ...
    >
      <circle cx="12" cy="12" r="12" fill="#C41E3A" fillOpacity="0.25" />
      <path
...
export function WhyUs() {
  ...
  return (
    <section
      ...
      aria-label="Why Choose JJM Facility Services"
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 flex flex-col items-center gap-12">
        ...
        >
          ...
          <h2 className="font-serif text-3xl md:text-4xl text-white text-balance">
            Why Choose JJM Facility Services?
          </h2>
        </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Benefit from a local, dependable team for all your commercial cleaning needs.
          </p>
          <QuoteModal>
            <Button
              size="lg"
