...
const serviceTypes = ['entretien régulier', 'vitrerie', 'remise en état']
...
export function Hero() {
  ...
  return (
    <section
      ...
      aria-label="Présentation Service Pro'Preté"
    >
      <SwirlPattern />

      {/* Ambient orb — lavande, top-right */}
      <div
        aria-hidden="true"
        className="absolute -top-32 -right-32 w-[500px] h-[500px] rounded-full pointer-events-none"
        style={{
          background: 'radial-gradient(circle, rgba(155,159,212,0.18) 0%, transparent 70%)',
          filter: 'blur(48px)',
        }}
      />
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(43,46,110,0.45) 0%, transparent 70%)',
          filter: 'blur(56px)',
        }}
      />
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-28 pb-24 md:pt-36 md:pb-28 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-[56px] text-white leading-[1.15] text-balance">
            ...
            <span className="italic text-[var(--lavande)]">Zéro prise de tête.</span>
          </h1>
